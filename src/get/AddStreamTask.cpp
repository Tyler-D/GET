...
AddStreamTask<Dtype>::~AddStreamTask()
{
...
template <typename Dtype>
void 
AddStreamTask<Dtype> :: PreCompute()
{
...
AddStreamTask<Dtype>::Compute()
{
    ...
    {
        kernel[i] = clCreateKernel(program, "addMatrix", &status);
...
template <typename Dtype>
void 
AddStreamTask<Dtype>::PostCompute()
{
}


template class AddStreamTask<int>;
template class AddStreamTask<long>;
template class AddStreamTask<float>;
template class AddStreamTask<double>;
