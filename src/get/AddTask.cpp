...
AddTask<Dtype>::Compute()
{
   //read program source and create kernel
    ...
    kernel = clCreateKernel(program, "addMatrix", &status);
...
template class AddTask<int>;
template class AddTask<float>;
template class AddTask<double>;
template class AddTask<long>;
