...
ReLUTask<Dtype>::Compute()
{
   //read program source and create kernel
    ...
    kernel = clCreateKernel(program, "ReLUMatrix", &status);
...
template class ReLUTask<int>;
template class ReLUTask<float>;
template class ReLUTask<double>;
template class ReLUTask<long>;
