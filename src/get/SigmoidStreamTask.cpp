...
SigmoidStreamTask<Dtype>::~SigmoidStreamTask()
{
...
template <typename Dtype>
void 
SigmoidStreamTask<Dtype> :: PreCompute()
{
...
template <typename Dtype>
void
SigmoidStreamTask<Dtype>::Compute()
{
    cl_int status;
    ...
    {
        kernel[i] = clCreateKernel(program, "sigMatrix", &status);
...
template <typename Dtype>
void 
SigmoidStreamTask<Dtype>::PostCompute()
{
}


template class SigmoidStreamTask<int>;
template class SigmoidStreamTask<long>;
template class SigmoidStreamTask<float>;
template class SigmoidStreamTask<double>;
