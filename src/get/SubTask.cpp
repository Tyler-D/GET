...
SubTask<Dtype>::Compute()
{
   //read program source and create kernel
    ...
    if (typeid(Dtype) == typeid(int))
         program_source = cl_readSource("/home/zy/GET/src/get/sub_task_int.cl");
    if (typeid(Dtype) == typeid(long))
         program_source = cl_readSource("/home/zy/GET/src/get/sub_task_long.cl");
    if (typeid(Dtype) == typeid(float))
         program_source = cl_readSource("/home/zy/GET/src/get/sub_task_float.cl");
    if (typeid(Dtype) == typeid(double))
         program_source = cl_readSource("/home/zy/GET/src/get/sub_task_double.cl");
