...
int main(int argc, char** argv)
{
    ...
    task_param.set_type(GET::TaskParam_TaskType_Sigmoid);
    GET::SigmoidParam *pSigmoidParam = task_param.mutable_sigmoid_param();

    pSigmoidParam->set_height(h);
    pSigmoidParam->set_width(w);

    SigmoidTaskDispatcher<int> rlu(task_param, &dm);
